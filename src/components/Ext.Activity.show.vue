<template>
    <div>
        ...
        <div class="user">
            ...
            <div class="none" v-if="status == 0" v-show="isTrue">
                <img :src="noComment">
                <p>还没有人评论</p>
            </div>
            <div class="user-item">
        ...
        <!--参与报名-->
        <div class="join" @click="having()" v-if="status == 11" v-show="isTrue">
            参与投票
        </div>
        <div class="notBegin" @click="notBegin()" v-if="status == 0" v-show="isTrue">
            活动还未开始
        </div>
        <div class="join-enroll" @click="joinEnroll()" v-if="status == 10" v-show="isTrue">
            参与报名
        </div>
        <div class="finished" @click="finished()" v-if="status == 20" v-show="isTrue">
            活动已结束
        </div>
        <!--在微信中打开-->
        <div class="weixin">
            ...
            having:function(){
                ...
                if(ua.match(/MicroMessenger/i) == 'micromessenger'){
                    ...
                    if (navigator.userAgent.match(/(iPhone|iPod|iPad);?/i)) {
                        window.location.href = "iOSBAN://?showActivityDetailIID="+newId;//ios app协议
                        window.setTimeout(function() {
                            window.location.href = "https://www.tosneaker.com/app/download?ADTAG=396.392";
                        }, 2000);
                    }else if (navigator.userAgent.match(/android/i)) {
                        window.location.href = 'ban://tosneaker.android/sys/activity/show?id='+newId;
                        setTimeout(function(){
            ...
            notBegin:function(){
                ...
                if(ua.match(/MicroMessenger/i) == 'micromessenger'){
                    ...
                    if (navigator.userAgent.match(/(iPhone|iPod|iPad);?/i)) {
                        window.location.href = "iOSBAN://?showActivityDetailIID="+newId;//ios app协议
                        window.setTimeout(function() {
                            window.location.href = "https://www.tosneaker.com/app/download?ADTAG=396.391";
                        }, 2000);
                    }else if (navigator.userAgent.match(/android/i)) {
                        window.location.href = 'ban://tosneaker.android/sys/activity/show?id='+newId;
                        setTimeout(function(){
                            window.location.href= "https://www.tosneaker.com/app/download?ADTAG=370.334"; //android下载地址
                        },2000);
                    }
                }
            },
            finished:function(){
                ...
                if(ua.match(/MicroMessenger/i) == 'micromessenger'){
                    ...
                    if (navigator.userAgent.match(/(iPhone|iPod|iPad);?/i)) {
                        window.location.href = "iOSBAN://?showActivityDetailIID="+newId;//ios app协议
                        window.setTimeout(function() {
                            window.location.href = "https://www.tosneaker.com/app/download?ADTAG=396.390";
                        }, 2000);
                    }else if (navigator.userAgent.match(/android/i)) {
                        window.location.href = 'ban://tosneaker.android/sys/activity/show?id='+newId;
                        setTimeout(function(){
                            window.location.href= "https://www.tosneaker.com/app/download?ADTAG=370.344"; //android下载地址
                        },2000);
                    }
                }
            },
            joinEnroll:function(){
                ...
                if(ua.match(/MicroMessenger/i) == 'micromessenger'){
                    ...
                    if (navigator.userAgent.match(/(iPhone|iPod|iPad);?/i)) {
                        window.location.href = "iOSBAN://?showActivityDetailIID="+newId;//ios app协议
                        window.setTimeout(function() {
                            window.location.href = "https://www.tosneaker.com/app/download?ADTAG=396.385";
                        }, 2000);
                    }else if (navigator.userAgent.match(/android/i)) {
                        window.location.href = 'ban://tosneaker.android/sys/activity/show?id='+newId;
                        setTimeout(function(){
                            window.location.href= "https://www.tosneaker.com/app/download?ADTAG=370.335"; //android下载地址
                        },2000);
                    }
                }
            },
